...
def api_trigger_attack():
    ...
    cmd_map = {
        "brute_force": [
            "python", "-m", "attacks.brute_force",
            "--target", target_url, "--delay", "0.1", "--attempts", "5",
        ],
        "sqli": [
            "python", "-m", "attacks.sqli",
            "--target", target_url, "--delay", "0.1", "--rounds", "1",
        ],
        "scan": [
            "python", "-m", "attacks.scan",
            "--target", target_url, "--delay", "0.05", "--rounds", "1",
        ],
        "xss": [
            "python", "-m", "attacks.xss",
            "--target", target_url, "--delay", "0.1", "--rounds", "1",
        ],
        "traversal": [
            "python", "-m", "attacks.traversal",
            "--target", target_url, "--delay", "0.1", "--rounds", "1",
        ],
        "enum": [
            "python", "-m", "attacks.enum",
            "--target", target_url, "--delay", "0.1", "--rounds", "1",
        ],
        "credential_stuffing": [
            "python", "-m", "attacks.credential_stuffing",
            "--target", target_url, "--delay", "0.1", "--rounds", "1",
        ],
        "full_chain": [
            "python", "-m", "attacks.full_chain",
            "--target", target_url, "--delay", "0.05",
        ],
    }
